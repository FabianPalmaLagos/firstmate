...
| `fm-pi.sh`               | Launch Pi from macOS, Linux, or Git Bash against this home's isolated Pi profile      |
| `fm-pi.ps1`              | Windows PowerShell counterpart of `fm-pi.sh` with identical isolation behavior        |
